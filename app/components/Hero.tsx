...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-black bg-audio-wave relative overflow-hidden pt-20 md:pt-24">
      {/* Background Elements */}
      ...
      <div className="absolute bottom-12 md:bottom-16 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-primary-silver text-xs mt-2 font-display tracking-wide">SCROLL</p>
        </motion.div>
      </div>
    </section>
  )
